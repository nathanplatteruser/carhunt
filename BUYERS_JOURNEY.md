# CarHunt & the Human Side of Buying a Truck
...
CarHunt is a tool I built for myself because shopping Facebook Marketplace for a family SUV felt like drinking from a firehose. Every listing looks the same at 10pm on a phone, prices are all over the map, and by the time you circle back to "the good one," it's sold.

So I taught my computer to do the tedious part. Here is everything it does, no jargon:

1. **It reads the listings so I don't have to.** Every week it looks at Facebook Marketplace across five metros — Lincoln–Omaha, Denver, Kansas City, Des Moines, and Minneapolis–St. Paul — and writes down every full-size 3-row SUV and half-ton truck between $20k and $50k. Right now that's about 740 vehicles.

2. **It figures out what each one is *actually* worth.** For every year, model, and trim it keeps a fair private-party value (anchored to the same KBB/Edmunds numbers a dealer would use), adjusts for mileage, and knocks 25% off anything with a rebuilt or salvage title. Then it compares the asking price to that number.

3. **It scores every vehicle 0–10** on discount vs. market, cost per remaining mile, model quality, distance from home, listing legitimacy, and title status. A 9 is a screaming deal; a 3 is a seller who loves their truck more than the market does.
...
5. Click **Draft DM**, edit the message so it sounds like me, copy it, and send it myself on Facebook. Then click **✓ messaged** — the row moves to my "waiting on seller" pile so the main list only ever shows fresh prospects.
...
4. **Show the work.** Photos of the repairs you already did cost you five minutes and won a same-day cash decision over 19 competitors. That is the cheapest marketing in the automotive industry.
