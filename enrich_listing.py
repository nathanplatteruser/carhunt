...
them in the free-text description - or only in Facebook's structured "About this
vehicle" block ("Driven 162,532 miles", "Mileage - 141,512"). This module fills gaps:
  ...
  2. When a field is null/invalid, fuzzy-match the page text and recover it.
...
def selftest():
    ...
    # FB structured-field formats ("Driven X miles", "Mileage - X")
